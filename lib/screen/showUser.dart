                       ...
                       Column(
                         children: [
                           ...
                           Container(
                            ...
                            BoxShape.circle,border:Border.all(color:Colors.pink)),
                            child: Padding(padding:EdgeInsets.all(8.0),child:Icon(Icons.trending_up,size: 30, ),)
                       ),
                       Text("للمراسله",style:TextStyle(color:Colors.black))],
                     ),
                      onTap:(){}
                      ),
                      ...
                      InkWell(
                        child: Column(
                          children:[Container(
                              ...
                              decoration: BoxDecoration(shape:
                              BoxShape.circle,border:Border.all(color:Colors.grey)),
                              child: Padding(padding:EdgeInsets.all(8.0),child:Icon(Icons.favorite_border,size: 30, ),)
                          ),
                            Text("للحفظ",style:TextStyle(color:Colors.black))],
                        ),
                          onTap:(){
